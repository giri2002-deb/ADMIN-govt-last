...
// // Updated mapUserToKCCMember to preserve breakdown and eligibleAmount with crops
...
//   // Compose category string from selected crops
...
//   // Map each selected crop to keep breakdown and eligibleAmount explicitly
...
//     amount:
//       calculatedFields.totalEligibleAmount ||
//       Number(loanDetails.totalEligibleAmount) ||
//       Number(userInfo.principle_amount) ||
//       0,
...
//   // Initial or empty data structure for originalData
...
//       address: "மருது ஞ்சாவடிஅஞ்‌சல், சங்கப்பிரி வட்டம், சேலம் மாவட்டம் - 637103",
...
//           landArea: 2.5,
//           farmerType: "MF" as const,
//           classification: "SC" as const,
...
//           id: "2",
//           serialNo: "002",
//           memberName: "லக்ஷ்மி எஸ்",
//           fatherName: "சுந்தரம்",
//           category: "கரும்பு",
//           landArea: 1.8,
//           farmerType: "SF" as const,
//           classification: "BC" as const,
//           aadhaarNo: "2345 6789 0123",
//           accountNo: "234 567 890",
//           phoneNo: "9765432109",
//           amount: 90000,
//           date: "2025-01-11",
//           selectedCrops: [
//             {
//               crop: { name_of_crop: "கரும்பு" },
//               acres: 1.8,
...
//           accountNo: "345 678 901",
//           phoneNo: "9654321098",
//           amount: 160000,
//           date: "2025-01-11",
//           selectedCrops: [
//             {
//               crop: { name_of_crop: "நெல்" },
//               acres: 3.2,
...
//   // Fetch data from server and map users
...
//       if (!data.success || !Array.isArray(data.users)) throw new Error("Unexpected server data format")
...
//   // Aggregate selected user details including breakdown sums accurately
...
//     // Loop selected users and aggregate details including using breakdown fields for expenses
//     selectedRawUsers.forEach((user) => {
//       const userJson = user.userjson || user

//       // Capture user info from first occurrence
...
//       // Land details and parcels capture
...
//       // Crop data aggregation with breakdown expense sums
...
//       // Friend details first occurrence
...
//   // Add selected members from preview to original form data, with checks and aggregation
...
//     // Update serial numbers sequentially after adding new
//     const updatedMembers = [...originalData.members, ...uniqueMembersToAdd].map((member, idx) => ({
//       ...member,
//       serialNo: (idx + 1).toString(),
//     }))

//     // Extract aggregated selected details
//     const selectedDetails = getSelectedUserDetails()

//     // Merge crop details and other aggregated info into originalData
//     const updatedData = {
//       ...originalData,
...
//   // Enhanced PDF Download with proper A4 sizing and all 4 pages
...
//   // Export filtered data to server
...
//       selectedUserDetails: getSelectedUserDetails(),
//       organizationInfo: filteredData.settings,
//     }

//     try {
//       const response = await fetch("http://localhost:5000/api/Kccdata", {
//         method: "POST",
...
//               }}
//             >
//               <KCCPage4 data={filteredData} isEditing={isEditing} />
//               <br>
// </br>
//     <div
//               className="pdf-page"
