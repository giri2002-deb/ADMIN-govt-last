  ...
  {/* all your page content here */}
      ...
      <div className="text-justify space-y-4">
        <p className="mb-8 text-justify">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;மேலும் இந்த ஒப்பந்த பத்திரம் 1983 ஆம் ஆண்டின் தமிழ்நாடு கூட்டுறவுச் சங்கங்களின் சட்டம் 
          (1983 ஆம் ஆண்டின் தமிழ்நாட்டுச் சட்டம் எண்.30) பிரிவு 41-ன் கீழ் குறிப்பிடப்பட்டுள்ள 
          எல்லா நிபந்தனைகளையும் உள்ளடக்கியதாகக் கருதப்படும் எனவும். எல்லா நிபந்தனைகளுக்கும் 
          உட்பட்டதெனவும் ஒப்புக்கொண்டு மேற்குறிப்பிட்ட கடன்தாரர்கள் இதன் வாயிலாக உறுதியளிக்றேன் / றோம்.
        </p>
        <p className="mb-8 text-justify">
  ...
  <div className="flex flex-col">
   {surveyList}
        ...
        <div className="flex">
          ...
          <span className="mr-4">:</span>
          <span>{userData?.calculatedFields?.totalLandArea}</span>
        </div>
      </div>
