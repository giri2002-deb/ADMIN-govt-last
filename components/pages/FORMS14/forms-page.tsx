...
// import Page11 from "@/components/pages/page-11"
// import StaticImagePage from "@/components/pages/static-image-page"
// import PanCardPage from "@/components/pages/pan-card-page"
// import RationCardPage from "@/components/pages/ration-card-page"
// import AadharCardPage from "@/components/pages/aadhar-card-page"
...
//   { component: Page8, title: "பயிர்க் கடன் பத்திரம்" },
//   { component: Page9, title: "பயிர் காப்பீடு திட்டம்" },
//   { component: Page10, title: "சுய உறுதி மொழி கடிதம்" },
//   { component: Page11, title: "பயிர்கடன் வேண்டிய உறுப்பினர் கடன் விண்ணப்பம்" },
//   {
...
//   },
//   {
//     component: RationCardPage,
//     title: "ரேஷன் கார்டு",
//     props: {},
//   },
//   {
//     component: AadharCardPage,
//     title: "ஆதார் கார்டு",
//     props: {},
//   },
// ]
...
//     try {
//       await generatePDF(pages, formData)
//     } catch (error) {
...
//             <div>
//               <h1 className="text-2xl font-bold text-gray-800">KCC விண்ணப்ப படிவம்</h1>
...
//           <div
//             id={`page-${currentPage}`}
//             className="w-[794px] h-[1123px] mx-auto bg-white relative overflow-hidden"
//             style={{
...
//             }}
//           >
//           {CurrentPageComponent === StaticImagePage ? (
//   <StaticImagePage imageUrl={pageProps.imageUrl ?? ""} />
// ) : (
//   <CurrentPageComponent data={formData} imageUrl={""} />
// )}
...
//                 index === currentPage ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-600 hover:bg-gray-300"
//               }`}
//             >
//               {index + 1}
//             </button>
...
import Page1 from "@/components/pages/KCCForm/page-1"
import Page2 from "@/components/pages/KCCForm/page-2"
import {Page3} from "@/components/pages/KCCForm/page-3"
import Page4 from "@/components/pages/KCCForm/page-4"
import Page5 from "@/components/pages/KCCForm/page-5"
import Page6 from "@/components/pages/KCCForm/page-6"
import Page7 from "@/components/pages/KCCForm/page-7"
import Page8 from "@/components/pages/KCCForm/page-8"
import Page9 from "@/components/pages/KCCForm/page-9"
import Page10 from "@/components/pages/KCCForm/page-10"
import Page11 from "@/components/pages/KCCForm/page-11"
import StaticImagePage from "@/components/pages/static-image-page"
import PanCardPage from "@/components/pages/KCCForm/pan-card-page"
import RationCardPage from "@/components/pages/KCCForm/ration-card-page"
import AadharCardPage from "@/components/pages/KCCForm/aadhar-card-page"
import voter from "@/components/pages/KCCForm/voter"
...
export default function FormsPage() {
  ...
  useEffect(() => {
    try {
      const stored = localStorage.getItem("kcc_userjson")
      if (stored) {
        setFormDataState(JSON.parse(stored))
      }
    } catch (err) {
      console.warn("Invalid stored user data. Resetting...")
      localStorage.removeItem("kcc_userjson")
    }
  }, [])
...
const API_URL = process.env.NEXT_PUBLIC_API_URL;
  try {
    const res = await fetch(`${API_URL}/api/user-data/${trimmedUNumber}`);
    if (!res.ok) {
    ...
    if (userData.loantype && userData.loantype !== "KCC") {
      alert("இந்த உ_எண் NO in KCC ");
      return;
    }
    
    setFormDataState(userData);
    localStorage.setItem("kcc_userjson", JSON.stringify(userData));
    console.log(localStorage.kcc_userjson)
    alert("✅ KCC கடன் பயனர் தகவல் பெறப்பட்டது");
  } catch (error) {
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg ">
          <div
  id={`page-${currentPage}`}
  className="w-[816px] h-[2500px] mx-auto bg-white relative"
  style={{
    fontFamily: "Tamil, 'Noto Sans Tamil', serif",
    fontSize: "12px",
    lineHeight: "1.4",
